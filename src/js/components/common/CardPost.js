...
function CardPost(props) {
    ...
    const listPost = post.map((post) => {
        ...
        return (
            <Grid xs={12} key={post.id} className={classes.rootGird} item>
                ...
                <Paper variant="outlined" square>
                    <CardContent className={classes.cardPadding}>
                        ...
                        <Divider light/>
                        <Typography>
                            {i18next.t('bid_time_remaining')} <Typography variant={'span'}
                                                                          color={'error'}> {post.bid_time_remaining} </Typography>
                        </Typography>
                    </CardContent>
